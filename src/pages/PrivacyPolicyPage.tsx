                        ...
                        <CardContent className="space-y-2">
                            {sections.map((section) => (
                                <div key={section.id}>
                                    ...
                                    >
                                        {t(
                                            `privacyPolicy.${section.key}.title`
                                        ) || section.id}
                                    </button>
                                    {section.subsections && (
                                        <div className="ml-4 space-y-1 mt-1">
                                            {section.subsections.map(
                                                (subId) => (
                                                    ...
                                                    >
                                                        {t(
                                                            `privacyPolicy.${section.key}.subsections.${subId}.title`
                                                        ) || subId}
                                                    </button>
                                                )
                                            )}
                ...
                <div className="flex-1">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="flex items-center justify-center gap-4 text-sm text-gray-500 mb-4">
                            ...
                            <span>{t("privacyPolicy.hero.effectiveDate")}</span>
                        </p>
                                            ...
                                            {section.subsections.map(
                                                (subId) => (
                                                    ...
                                                    >
                                                        ...
                                                        {Array.isArray(
                                                            t(
                                                                `privacyPolicy.${section.key}.subsections.${subId}.content`
                                                            )
                                                        ) ? (
                                    ...
                                    {section.key === "sections.12" && (
                                        <div className="mt-4">
                                            <p className="text-gray-600">
                                                ...
                                                <br />
                                                {t(
                                                    `privacyPolicy.${section.key}.companyInfo.address`
                                                ) || "Surakarta"}
                                                <br />
                                                {t(
                                                    `privacyPolicy.${section.key}.companyInfo.phone`
                                                ) || "+6281510123155"}
                                            </p>
                                            <p className="text-gray-600 mt-2">
                                                {t(
                                                    `privacyPolicy.${section.key}.legalNote`
                                                ) ||
